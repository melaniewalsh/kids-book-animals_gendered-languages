<script>
	...
	const flags = $derived([
		...
		{ id: "mexican_flag", top: "28%", left: "65.5%", width: 100 },

		{ id: "german_flag", top: "28%", left: "65.5%", width: 95 },
		{ id: "greek_flag", top: "28%", left: "65.5%", width: 95 },

		// { id: "german_flag", top: "93%", left: "50.8%", width: 90 },
		// { id: "der_Frosch", top: "14%", left: "50.5%", width: 150 },
		// { id: "mexican_flag", top: "93%", width: 90 },

		{ id: "spanish_flag", top: "28%", left: "65.5%", width: 95 },
		{ id: "french_flag", top: "28%", left: "65.5%", width: 95 },
		{ id: "india_flag", top: "28%", left: "65.5%", width: 95 },
		{ id: "egypt_flag", top: "28%", left: "65.5%", width: 95 },
		{ id: "russian_flag", top: "28%", left: "65.5%", width: 95 },
		{ id: "polish_flag", top: "28%", left: "65.5%", width: 95 },

		{ id: "brazilian_flag", top: "28%", left: "65.5%", width: 95 },
		{ id: "italian_flag", top: "28%", left: "65.5%", width: 95 }
	...
	const words = $derived([
		{ id: "la_rana", top: "96%", left: "44.5%", width: 150 },
		{ id: "der_Frosch", top: "96%", left: "44.5%", width: 150 },
		{ id: "vatrachos", top: "96%", left: "44.5%", width: 150 },
		{ id: "la_rana", top: "96%", left: "44.5%", width: 150 },
		{ id: "la_grenouille", top: "96%", left: "44.5%", width: 175 }
...
<div class="wrapper" class:ready={dimensions.width && dimensions.width > 0}>
	<img class="frog" src="assets/hero/frog_flag4.png" alt="frog" />
	...
	{#each flags as { id, top, left, width }, i}
		...
		<img
			...
			style:transform={`translate(-50%, 0) rotate(${active ? "7deg" : "0deg"})`}
			style:top
		/>
	{/each}
	<!-- 
